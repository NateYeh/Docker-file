...
if [ "$1" = "16" ]; then
    ...
    sudo docker run -d -p 5122:22 -p 5188:8888 --name="home" -h "home" --restart=always --cap-add=ALL --privileged --device=/dev/dri:/dev/dri -v /volume2/public/work:/home/nate/work -v /volume2/public/cache:/mnt/cache home:20211125
else
